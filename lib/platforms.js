...
/** Host-aware read hint for SKILL.md references in chat workflows */
function skillReadHint(skillName) {
  return [
    `Read \`${skillName}\` from your host skills dir (sibling preferred), e.g.`,
    `\`~/.cursor/skills/${skillName}/SKILL.md\`,`,
    `\`~/.claude/skills/${skillName}/SKILL.md\`,`,
    `\`~/.grok/skills/${skillName}/SKILL.md\`,`,
    `\`~/.agents/skills/${skillName}/SKILL.md\`,`,
    `or legacy \`~/.claude/commands/${skillName}.md\`.`,
  ].join(' ');
}

const DELIBERATION_PROTOCOL_READ = skillReadHint('deliberation-protocol');
